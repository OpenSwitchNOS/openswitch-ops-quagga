            ...
            if (!strcmp(ovs_cfilter->type,"extcommunity-list")) {
                for (i = 0; i < ovs_cfilter->n_permit; i++) {
                    ...
                    if (!ret) {
                        ...
                        VLOG_ERR("Extcommunity filter permit configuration"
                                 " changes not set");
                    }
                }
                ...
                for (i = 0; i < ovs_cfilter->n_permit; i++) {
                    ...
                    if (!ret) {
                        ...
                        VLOG_ERR("Community filter permit configuration"
                                 " changes not set");
                    }
                }
            }
            ...
            if (!strcmp(ovs_cfilter->type,"extcommunity-list")) {
                for (i = 0; i < ovs_cfilter->n_deny; i++) {
                    ...
                    if (!ret) {
                        ...
                        VLOG_ERR("Extcommunity filter deny configuration"
                                 " changes not set");
                    }
                ...
                for (i = 0; i < ovs_cfilter->n_deny; i++) {
                    ...
                    if (!ret) {
                        ...
                        VLOG_ERR("Community filter deny configuration"
                                 " changes not set");
                    }
                }
            }
