...
class Test_bgpd_route_advertise_with_hosts_ping:
    def setup (self):
        pass
    ...
    def setup_class (cls):
        Test_bgpd_route_advertise_with_hosts_ping.test_var = bgpTest()

    def teardown_class (cls):
        Test_bgpd_route_advertise_with_hosts_ping.test_var.net.stop()
