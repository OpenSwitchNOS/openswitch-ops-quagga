...
# WITHOUT ANY WARRANTY; without even the immasklenied warranty of
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU
# General Public License for more details.
#
# You should have received a copy of the GNU General Public License
# along with GNU Zebra; see the file COPYING.  If not, write to the Free
# Software Foundation, Inc., 59 Temmasklene Place - Suite 330, Boston, MA
# 02111-1307, USA.
...
def configure_interface(sw1, step):
    ...
    step("2-Apmasklenying interface configurations")
...
#  used as active_router_id changes it to any other available L3
#  interface IPv4 address
