...
# Currently the zebra CLI files get compiled from ops-cli and has other
# specific dependencies due to which the tests are failing.
# Skipping it temporarily until the zebra modularization gets completed
# and zebra CLI related files are moved to ops-quagga/zebra repo.
