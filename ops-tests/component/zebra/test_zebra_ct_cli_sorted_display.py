...
def test_static_route_config(topology, step):
    ...
    rib_ipv4_layer3_connected_route_1[sw1_intf1] = dict()
    rib_ipv4_layer3_connected_route_1[sw1_intf1]['Distance'] = '0'
    rib_ipv4_layer3_connected_route_1[sw1_intf1]['Metric'] = '0'
    rib_ipv4_layer3_connected_route_1[sw1_intf1]['RouteType'] = 'connected'
    ...
    rib_ipv6_layer3_connected_route_1[sw1_intf1] = dict()
    rib_ipv6_layer3_connected_route_1[sw1_intf1]['Distance'] = '0'
    rib_ipv6_layer3_connected_route_1[sw1_intf1]['Metric'] = '0'
    rib_ipv6_layer3_connected_route_1[sw1_intf1]['RouteType'] = 'connected'

    # Populate the expected FIB ("show ipv6 route") route dictionary for the
    # connected IPv6 route for layer-3 interface '1'.
    ...
    rib_ipv4_layer3_connected_route_2['NumberNexthops'] = '1'
    rib_ipv4_layer3_connected_route_2[sw1_intf2] = dict()
    rib_ipv4_layer3_connected_route_2[sw1_intf2]['Distance'] = '0'
    rib_ipv4_layer3_connected_route_2[sw1_intf2]['Metric'] = '0'
    rib_ipv4_layer3_connected_route_2[sw1_intf2]['RouteType'] = 'connected'
    ...
    rib_ipv6_layer3_connected_route_2['NumberNexthops'] = '1'
    rib_ipv6_layer3_connected_route_2[sw1_intf2] = dict()
    rib_ipv6_layer3_connected_route_2[sw1_intf2]['Distance'] = '0'
    rib_ipv6_layer3_connected_route_2[sw1_intf2]['Metric'] = '0'
    rib_ipv6_layer3_connected_route_2[sw1_intf2]['RouteType'] = 'connected'

    # Populate the expected FIB ("show ipv6 route") route dictionary for the
    # connected IPv6 route for layer-3 interface '2'.
    ...
    rib_ipv4_layer3_connected_route_3['NumberNexthops'] = '1'
    rib_ipv4_layer3_connected_route_3[sw1_intf3] = dict()
    rib_ipv4_layer3_connected_route_3[sw1_intf3]['Distance'] = '0'
    rib_ipv4_layer3_connected_route_3[sw1_intf3]['Metric'] = '0'
    rib_ipv4_layer3_connected_route_3[sw1_intf3]['RouteType'] = 'connected'
    ...
    rib_ipv6_layer3_connected_route_3['NumberNexthops'] = '1'
    rib_ipv6_layer3_connected_route_3[sw1_intf3] = dict()
    rib_ipv6_layer3_connected_route_3[sw1_intf3]['Distance'] = '0'
    rib_ipv6_layer3_connected_route_3[sw1_intf3]['Metric'] = '0'
    rib_ipv6_layer3_connected_route_3[sw1_intf3]['RouteType'] = 'connected'

    # Populate the expected FIB ("show ipv6 route") route dictionary for the
    # connected IPv6 route for layer-3 interface '3'.
    ...
    verify_show_rib(
        ...
        aux_route,
        'connected',
        rib_ipv4_layer3_connected_route_1)

    aux_route = fib_ipv4_layer3_connected_route_2["Route"]
    verify_show_ip_route(sw1, aux_route, 'connected',
                         fib_ipv4_layer3_connected_route_2)
    aux_route = rib_ipv4_layer3_connected_route_2["Route"]
    verify_show_rib(
        sw1,
        aux_route,
        'connected',
        rib_ipv4_layer3_connected_route_2)

    aux_route = fib_ipv4_layer3_connected_route_3["Route"]
    verify_show_ip_route(sw1, aux_route, 'connected',
                         fib_ipv4_layer3_connected_route_3)
    aux_route = rib_ipv4_layer3_connected_route_3["Route"]
    verify_show_rib(
        sw1,
        aux_route,
        'connected',
        rib_ipv4_layer3_connected_route_3)
    ...
    verify_show_rib(
        ...
        aux_route,
        'connected',
        rib_ipv6_layer3_connected_route_1)

    aux_route = fib_ipv6_layer3_connected_route_2["Route"]
    verify_show_ipv6_route(sw1, aux_route, 'connected',
                           fib_ipv6_layer3_connected_route_2)
    aux_route = rib_ipv6_layer3_connected_route_2["Route"]
    verify_show_rib(
        sw1,
        aux_route,
        'connected',
        rib_ipv6_layer3_connected_route_2)

    aux_route = fib_ipv6_layer3_connected_route_3["Route"]
    verify_show_ipv6_route(sw1, aux_route, 'connected',
                           fib_ipv6_layer3_connected_route_3)
    aux_route = rib_ipv6_layer3_connected_route_3["Route"]
    verify_show_rib(
        sw1,
        aux_route,
        'connected',
        rib_ipv6_layer3_connected_route_3)
    ...
    sw1('configure terminal')
    sw1('ip route 20.20.20.0/24 %s' % sw1_intf2)
    sw1('ip route 10.0.0.0/24 %s' % sw1_intf2)
    sw1('ip route 10.0.0.0/32 %s' % sw1_intf1)
    sw1('ip route 30.30.0.0/16 %s' % sw1_intf1)

    step("### Adding IPv6 routes with various prefixes and nexthops ###")
    sw1('ipv6 route 2001::/32 %s' % sw1_intf2)
    sw1('ipv6 route 2001::/96 %s' % sw1_intf2)
    sw1('ipv6 route ::/128 %s' % sw1_intf1)
    sw1('ipv6 route 1:1::/127 %s' % sw1_intf1)
    ...
    expected_showrun_prefixes = \
        ['ip route 10.0.0.0/24 %s' % sw1_intf2,
         'ip route 10.0.0.0/32 %s' % sw1_intf1,
         'ip route 20.20.20.0/24 %s' % sw1_intf2,
         'ip route 30.30.0.0/16 %s' % sw1_intf1,
         'ipv6 route ::/128 %s' % sw1_intf1,
         'ipv6 route 1:1::/127 %s' % sw1_intf1,
         'ipv6 route 2001::/32 %s' % sw1_intf2,
         'ipv6 route 2001::/96 %s' % sw1_intf2]
