...
def test_static_route_config(topology, step):
    ...
    rib_ipv4_layer3_connected_route_primary_1 = dict()
    rib_ipv4_layer3_connected_route_primary_1['Route'] = '11.0.0.0/24'
    rib_ipv4_layer3_connected_route_primary_1['NumberNexthops'] = '1'
    rib_ipv4_layer3_connected_route_primary_1['1'] = dict()
    rib_ipv4_layer3_connected_route_primary_1['1']['Distance'] = '0'
    rib_ipv4_layer3_connected_route_primary_1['1']['Metric'] = '0'
    rib_ipv4_layer3_connected_route_primary_1['1']['RouteType'] = 'connected'

    # Populate the expected FIB ("show ip route") route dictionary for the
    # connected IPv4 route for layer-3 interface '1'.
    fib_ipv4_layer3_connected_route_primary_1 = rib_ipv4_layer3_connected_route_primary_1

    # Populate the expected RIB ("show rib") route dictionary for the connected
    # IPv6 route for layer-3 interface '1'.
    rib_ipv6_layer3_connected_route_primary_1 = dict()
    rib_ipv6_layer3_connected_route_primary_1['Route'] = '1001::/120'
    rib_ipv6_layer3_connected_route_primary_1['NumberNexthops'] = '1'
    rib_ipv6_layer3_connected_route_primary_1['1'] = dict()
    rib_ipv6_layer3_connected_route_primary_1['1']['Distance'] = '0'
    rib_ipv6_layer3_connected_route_primary_1['1']['Metric'] = '0'
    rib_ipv6_layer3_connected_route_primary_1['1']['RouteType'] = 'connected'

    # Populate the expected FIB ("show ipv6 route") route dictionary for the connected
    # IPv6 route for layer-3 interface '1'.
    fib_ipv6_layer3_connected_route_primary_1 = rib_ipv6_layer3_connected_route_primary_1

    # Populate the expected RIB ("show rib") route dictionary for the connected
    # IPv4 route for layer-3 interface '2'.
    rib_ipv4_layer3_connected_route_primary_2 = dict()
    rib_ipv4_layer3_connected_route_primary_2['Route'] = '22.0.0.0/24'
    rib_ipv4_layer3_connected_route_primary_2['NumberNexthops'] = '2'
    rib_ipv4_layer3_connected_route_primary_2['2'] = dict()
    rib_ipv4_layer3_connected_route_primary_2['2']['Distance'] = '0'
    rib_ipv4_layer3_connected_route_primary_2['2']['Metric'] = '0'
    rib_ipv4_layer3_connected_route_primary_2['2']['RouteType'] = 'connected'

    # Populate the expected RIB ("show ip route") route dictionary for the connected
    # IPv4 route for layer-3 interface '2'.
    fib_ipv4_layer3_connected_route_primary_2 = rib_ipv4_layer3_connected_route_primary_2

    # Populate the expected RIB ("show rib") route dictionary for the connected
    # IPv6 route for layer-3 interface '2'.
    rib_ipv6_layer3_connected_route_primary_2 = dict()
    rib_ipv6_layer3_connected_route_primary_2['Route'] = '2001::/120'
    rib_ipv6_layer3_connected_route_primary_2['NumberNexthops'] = '2'
    rib_ipv6_layer3_connected_route_primary_2['2'] = dict()
    rib_ipv6_layer3_connected_route_primary_2['2']['Distance'] = '0'
    rib_ipv6_layer3_connected_route_primary_2['2']['Metric'] = '0'
    rib_ipv6_layer3_connected_route_primary_2['2']['RouteType'] = 'connected'

    # Populate the expected FIB ("show ipv6 route") route dictionary for the connected
    # IPv6 route for layer-3 interface '2'.
    fib_ipv6_layer3_connected_route_primary_2 = rib_ipv6_layer3_connected_route_primary_2

    # Populate the expected RIB ("show rib") route dictionary for the connected
    # IPv4 route for layer-3 interface '3'.
    rib_ipv4_layer3_connected_route_primary_3 = dict()
    rib_ipv4_layer3_connected_route_primary_3['Route'] = '33.0.0.0/24'
    rib_ipv4_layer3_connected_route_primary_3['NumberNexthops'] = '3'
    rib_ipv4_layer3_connected_route_primary_3['3'] = dict()
    rib_ipv4_layer3_connected_route_primary_3['3']['Distance'] = '0'
    rib_ipv4_layer3_connected_route_primary_3['3']['Metric'] = '0'
    rib_ipv4_layer3_connected_route_primary_3['3']['RouteType'] = 'connected'

    # Populate the expected FIB ("show ip route") route dictionary for the connected
    # IPv4 route for layer-3 interface '3'.
    fib_ipv4_layer3_connected_route_primary_3 = rib_ipv4_layer3_connected_route_primary_3

    # Populate the expected RIB ("show rib") route dictionary for the connected
    # IPv6 route for layer-3 interface '3'.
    rib_ipv6_layer3_connected_route_primary_3 = dict()
    rib_ipv6_layer3_connected_route_primary_3['Route'] = '3001::/120'
    rib_ipv6_layer3_connected_route_primary_3['NumberNexthops'] = '3'
    rib_ipv6_layer3_connected_route_primary_3['3'] = dict()
    rib_ipv6_layer3_connected_route_primary_3['3']['Distance'] = '0'
    rib_ipv6_layer3_connected_route_primary_3['3']['Metric'] = '0'
    rib_ipv6_layer3_connected_route_primary_3['3']['RouteType'] = 'connected'

    # Populate the expected FIB ("show ipv6 route") route dictionary for the connected
    # IPv6 route for layer-3 interface '3'.
    fib_ipv6_layer3_connected_route_primary_3 = rib_ipv6_layer3_connected_route_primary_3

    # Verifying the connected routes showing up in the "show ip/ipv6 route" and
    # "show rib" CLI
    aux_route = fib_ipv4_layer3_connected_route_primary_1["Route"]
    verify_show_ip_route(sw1, aux_route, 'connected',
                         fib_ipv4_layer3_connected_route_primary_1)
    aux_route = rib_ipv4_layer3_connected_route_primary_1["Route"]
    verify_show_rib(sw1, aux_route, 'connected', rib_ipv4_layer3_connected_route_primary_1)

    # Verify IPv6 route for layer-3 primary address and next-hops in RIB and FIB
    aux_route = fib_ipv6_layer3_connected_route_primary_1["Route"]
    verify_show_ipv6_route(sw1, aux_route, 'connected',
                           fib_ipv6_layer3_connected_route_primary_1)
    aux_route = rib_ipv6_layer3_connected_route_primary_1["Route"]
    verify_show_rib(sw1, aux_route, 'connected', rib_ipv6_layer3_connected_route_primary_1)
