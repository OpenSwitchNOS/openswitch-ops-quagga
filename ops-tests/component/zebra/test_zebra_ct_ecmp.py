...
def _configure_switches(topology, step):
    ...
    sw1_fib_ipv4_layer3_connected_route_1 = sw1_rib_ipv4_layer3_connected_route_1
    ...
    # IPv4 route for layer-3 interface '2'.
    sw1_fib_ipv4_layer3_connected_route_2 = sw1_rib_ipv4_layer3_connected_route_2
    ...
    # IPv4 route for layer-3 interface '3'.
    sw1_fib_ipv4_layer3_connected_route_3 = sw1_rib_ipv4_layer3_connected_route_3
    ...
    # Populate the expected FIB ("show ip route") route dictionary for the connected
    # IPv4 route for layer-3 interface '4'.
    sw1_fib_ipv4_layer3_connected_route_4 = sw1_rib_ipv4_layer3_connected_route_4
    ...
    verify_show_ip_route(sw1, aux_route, 'connected', sw1_fib_ipv4_layer3_connected_route_1)
    aux_route = sw1_rib_ipv4_layer3_connected_route_1["Route"]
    verify_show_rib(sw1, aux_route, 'connected', sw1_rib_ipv4_layer3_connected_route_1)

    # Verify route 10.0.20.0/24 and next-hops in RIB and FIB
    aux_route = sw1_fib_ipv4_layer3_connected_route_2["Route"]
    verify_show_ip_route(sw1, aux_route, 'connected', sw1_fib_ipv4_layer3_connected_route_2)
    aux_route = sw1_rib_ipv4_layer3_connected_route_2["Route"]
    verify_show_rib(sw1, aux_route, 'connected', sw1_rib_ipv4_layer3_connected_route_2)

    # Verify route 10.0.30.0/24 and next-hops in RIB and FIB
    aux_route = sw1_fib_ipv4_layer3_connected_route_3["Route"]
    verify_show_ip_route(sw1, aux_route, 'connected', sw1_fib_ipv4_layer3_connected_route_3)
    aux_route = sw1_rib_ipv4_layer3_connected_route_3["Route"]
    verify_show_rib(sw1, aux_route, 'connected', sw1_rib_ipv4_layer3_connected_route_3)

    # Verify route 10.0.40.0/24 and next-hops in RIB and FIB
    aux_route = sw1_fib_ipv4_layer3_connected_route_4["Route"]
    verify_show_ip_route(sw1, aux_route, 'connected', sw1_fib_ipv4_layer3_connected_route_4)
    aux_route = sw1_rib_ipv4_layer3_connected_route_4["Route"]
    verify_show_rib(sw1, aux_route, 'connected', sw1_rib_ipv4_layer3_connected_route_4)

    # Verify route 10.0.70.0/24 and next-hops in RIB and FIB
    aux_route = sw1_fib_ipv4_layer3_static_route_1["Route"]
    verify_show_ip_route(sw1, aux_route, 'static', sw1_fib_ipv4_layer3_static_route_1)
    aux_route = sw1_rib_ipv4_layer3_static_route_1["Route"]
    verify_show_rib(sw1, aux_route, 'static', sw1_rib_ipv4_layer3_static_route_1)
    ...
    # Populate the expected FIB ("show ip route") route dictionary for the
    # connected IPv4 route for layer-3 interface '1'.
    sw2_fib_ipv4_layer3_connected_route_1 = sw2_rib_ipv4_layer3_connected_route_1
    ...
    # Populate the expected RIB ("show ip route") route dictionary for the connected
    # IPv4 route for layer-3 interface '2'.
    sw2_fib_ipv4_layer3_connected_route_2 = sw2_rib_ipv4_layer3_connected_route_2
    ...
    # Populate the expected FIB ("show ip route") route dictionary for the connected
    # IPv4 route for layer-3 interface '3'.
    sw2_fib_ipv4_layer3_connected_route_3 = sw2_rib_ipv4_layer3_connected_route_3
    ...
    verify_show_ip_route(sw2, aux_route, 'connected', sw2_fib_ipv4_layer3_connected_route_1)
    aux_route = sw2_rib_ipv4_layer3_connected_route_1["Route"]
    verify_show_rib(sw2, aux_route, 'connected', sw2_rib_ipv4_layer3_connected_route_1)

    # Verify route 10.0.40.0/24 and next-hops in RIB and FIB
    aux_route = sw2_fib_ipv4_layer3_connected_route_2["Route"]
    verify_show_ip_route(sw2, aux_route, 'connected', sw2_fib_ipv4_layer3_connected_route_2)
    aux_route = sw2_rib_ipv4_layer3_connected_route_2["Route"]
    verify_show_rib(sw2, aux_route, 'connected', sw2_rib_ipv4_layer3_connected_route_2)

    # Verify route 10.0.70.0/24 and next-hops in RIB and FIB
    aux_route = sw2_fib_ipv4_layer3_connected_route_3["Route"]
    verify_show_ip_route(sw2, aux_route, 'connected', sw2_fib_ipv4_layer3_connected_route_3)
    aux_route = sw2_rib_ipv4_layer3_connected_route_3["Route"]
    verify_show_rib(sw2, aux_route, 'connected', sw2_rib_ipv4_layer3_connected_route_3)

    # Verify route 10.0.10.0/24 and next-hops in RIB and FIB
    aux_route = sw2_fib_ipv4_layer3_static_route_1["Route"]
    verify_show_ip_route(sw2, aux_route, 'static', sw2_fib_ipv4_layer3_static_route_1)
    aux_route = sw2_rib_ipv4_layer3_static_route_1["Route"]
    verify_show_rib(sw2, aux_route, 'static', sw2_rib_ipv4_layer3_static_route_1)

    # Verify route 10.0.20.0/24 and next-hops in RIB and FIB
    aux_route = sw2_fib_ipv4_layer3_static_route_2["Route"]
    verify_show_ip_route(sw2, aux_route, 'static', sw2_fib_ipv4_layer3_static_route_2)
    aux_route = sw2_rib_ipv4_layer3_static_route_2["Route"]
    verify_show_rib(sw2, aux_route, 'static', sw2_rib_ipv4_layer3_static_route_2)
