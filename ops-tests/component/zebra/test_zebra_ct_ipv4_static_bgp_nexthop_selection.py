...
def add_static_bgp_routes(sw1, sw2, step):
    ...
    rib_ipv4_static_route1['{}'.format(sw1.ports["if02"])]['Distance'] = '10'
    ...
    rib_ipv4_static_route1['{}'.format(sw1.ports["if03"])]['Distance'] = '10'
...
def shutdown_static_bgp_routes_next_hop_interfaces(sw1, sw2, step):
    ...
    route_ipv4_static_route1['{}'.format(sw1.ports["if02"])]['Distance'] = '10'
