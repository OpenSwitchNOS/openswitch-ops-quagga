...
def verify_route_in_show_kernel_route(sw, if_ipv4, expected_route_dict,
    ...
    # Get the actual kernel route dictionary for the route. Execute the Unix
    # command until the route is seen in the output, else sleep for a second in
...
def verify_active_router_id_in_vrf(sw, expected_active_router_id):
    ...
    :param sw : Device object
    :type  sw : topology.platforms.base.BaseNode
    :param expected_active_router_id : Ip address of the first L3 interface
                                       configured
    :type route : string
    """
