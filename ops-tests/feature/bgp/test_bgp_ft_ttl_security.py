...
bgp_sw1_config.append(["router bgp %s" % sw1_asn,
                       ...
                       "neighbor 172.20.16.2 ttl-security hops 2"])
...
bgp_sw3_config.append(["router bgp %s" % sw3_asn,
                       ...
                       "neighbor 172.20.15.1 ttl-security hops 2"])
...
def check_bgp_session(step):
    step("\n Verifying bgp connection between switch 1 and switch 3...\n")
...
@mark.timeout(600)
def test_bgp_ttl_security(topology, step):
    global switches
