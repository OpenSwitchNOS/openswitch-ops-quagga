...
def configure_verify(dut01):
    ...
    red_vrf = get_vrf_namespace(dut01)
...
def interface_move_verify(dut01):
...
class Test_vrf_static_routes:
    ...
    def test_feature(self):
        ...
        configure_verify(dut01Obj)
        interface_move_verify(dut01Obj)
        unconfigure_verify(dut01Obj)
