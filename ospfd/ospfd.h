...
#define OSPF_MASTER_SHUTDOWN (1 << 0) /* deferred-shutdown */
  ...
  /* Global OSPF enable flag */
#define GLOBAL_OSPF_PROCESS_DISABLE 0
#define GLOBAL_OSPF_PROCESS_ENABLE 1
  u_char ospf_global_en;
};
...
#ifdef OPS_QUAGGA
int ospf_interface_area_set (struct ospf *, struct ospf_area *, const char *);
int ospf_interface_area_unset (struct ospf *, struct ospf_area *, const char *);
#endif //OPS_QUAGGA
