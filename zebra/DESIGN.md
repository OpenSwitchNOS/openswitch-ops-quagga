...
Responsibilities
----------------
The main responsibility of ops-zebra is to read routes and next hop configurations from the OVSDB and select the best of these active routes and program them into the kernel.
...
* Zebra takes all the advertised routes into account and internally decides the best set of next hops for the routes.
