...
class demoTest( HalonTest ):
    ...
    def testConfigure(self):
        ...
        #HALON_TODO: vtysh infra has an issue while adding and attaching multiple interfaces to the vrf.
        # Once that part of the code is fixed, the following line can be removed. As of now, sometimes
        # the interface does not get added to the vrf.
        ...
        #s2.cmdCLI("routing")
        s2.cmdCLI("vrf attach vrf_default")
    ...
    def testV6(self):
        ...
        #HALON_TODO: For IPv6, we see that even after setting static routes correctly, direct ping from h1 to h2 is not taking place.
        # After subsequent pings between adjacent devices, end to end ping works. We suspect that there is some learning going on in
        # the kernel as regards to neighbour advertisements.
