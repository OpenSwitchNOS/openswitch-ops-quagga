...
zebra_handle_port_add_delete_changes (void)
{
  ...
  if (VLOG_IS_DBG_ENABLED())
    {
      zebra_l3_port_walk_cache_and_print(NULL, &zebra_cached_l3_ports, true);
      zebra_l3_port_walk_cache_and_print(NULL, &zebra_updated_or_changed_l3_ports,
                                         false);
    }
      ...
      if (VLOG_IS_DBG_ENABLED())
        {
          ...
          zebra_dump_internal_route_table(NULL, vrf_shadow_table(AFI_IP,
                                                                 SAFI_UNICAST,
                                                                 0));
          zebra_dump_internal_route_table(NULL,vrf_shadow_table(AFI_IP6,
                                                                SAFI_UNICAST,
                                                                0));
        }
